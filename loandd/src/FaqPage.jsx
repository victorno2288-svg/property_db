...
const FAQ_DATA = [
  ...
  {
    category: 'ทำไมต้อง LoanDD',
    icon: '⭐',
    items: [
      {
        q: 'LoanDD คืออะไร และช่วยผู้ซื้อได้อย่างไร?',
        a: 'LoanDD คือบริษัทที่ซื้อทรัพย์มารีโนเวทเองทุกหลัง แล้วจำหน่ายตรงถึงผู้ซื้อ — ไม่รับฝากขายจากบุคคลภายนอก\n\nสิ่งที่ได้รับเมื่อซื้อกับ LoanDD:\n• ทรัพย์ทุกรายการผ่านการรีโนเวทและตรวจสอบโฉนดแล้ว\n• ราคาเป็นธรรม ซื้อตรงจาก LoanDD ไม่ผ่านคนกลาง\n• ทีมงานดูแลตลอดกระบวนการตั้งแต่ชมทรัพย์จนโอนกรรมสิทธิ์',
      },
      {
        q: 'ทรัพย์ของ LoanDD ผ่านกระบวนการอะไรบ้างก่อนขาย?',
        a: 'ทุกหลังที่ LoanDD นำออกจำหน่ายผ่านกระบวนการครบถ้วน:\n\n🔨 รีโนเวทโดยทีม LoanDD — ปรับปรุงสภาพพร้อมเข้าอยู่\n✅ ตรวจสอบโฉนด — เลขที่ดิน เนื้อที่ ชื่อเจ้าของถูกต้อง\n✅ ตรวจภาระผูกพัน — ไม่มีหนี้ค้างชำระ ไม่ถูกอายัด\n✅ ตรวจสิ่งปลูกสร้าง — ใบอนุญาตก่อสร้างถูกกฎหมาย\n✅ ราคาเป็นธรรม — เทียบเคียงราคาตลาดในทำเลเดียวกัน',
      },
      {
        q: 'ติดต่อ LoanDD เพื่อขอคำปรึกษาได้อย่างไร?',
  ...
  return (
    <div style={{ fontFamily: '"Noto Sans Thai", sans-serif', background: '#f8faf9', minHeight: '100vh' }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.88rem', marginBottom: 18 }}>
            รวมคำตอบทุกข้อสงสัยเรื่องการซื้อ-ขาย-เช่า อสังหาริมทรัพย์ กับ LoanDD
          </p>
      ...
      <section style={{ background: '#fff', padding: '50px 0 60px', borderTop: '1px solid #eee' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <p style={{ color: '#888', fontSize: '0.9rem' }}>จากการค้นหาจนถึงรับกุญแจ LoanDD ดูแลทุกขั้นตอน</p>
          </div>
          <div style={{
            display: 'grid',
      ...
      <footer style={{ background: '#1a1a1a', padding: '24px 0', textAlign: 'center', color: '#aaa' }}>
        <div className="container">
          <p style={{ margin: 0, fontSize: '0.82rem' }}>&copy; 2026 LoanDD Co., Ltd. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
